...
export const Calculator: React.FC = (): React.ReactElement => {
  ...
  const outputDisplay: string = useSelector(
    (state: calculatorStateT) => state.display
  );
  const functionDisplay: string = useSelector(
    (state: calculatorStateT) => state.funcDisplay
  );
  const nextOpDisplay: string = useSelector(
    (state: calculatorStateT) => state.nextOp
  );
  ...
  return (
    <div id="calculator">
      <div id="formulaScreen">
        {functionDisplay + nextOpDisplay + outputDisplay}
      </div>
